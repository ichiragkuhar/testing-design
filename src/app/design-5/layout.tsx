...
export default function ContemporaryLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className={`${s.site} ${bricolage.variable}`}>
      <header className={s.header}>
        <div className={`page-grid ${s.headerRow}`}>
      ...
      <footer className={s.footer}>
        <div className={`page-grid ${s.footerGrid}`}>
          <Image
        ...
        <div className={`page-grid ${s.footerLegal}`}>
          <p>
